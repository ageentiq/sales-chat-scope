...
const translations = {
  ar: {
    ...
    conversationsStarted: 'المحادثات',
    ...
    conversationsStartedTooltip: 'إجمالي عدد المحادثات الفريدة في الفترة المحددة',
  ...
  en: {
    ...
    conversationsStartedTooltip: 'Total number of unique conversations in the selected period',
