...
const translations = {
  ar: {
    ...
    emailConfirmationSent: 'تم إرسال رسالة تأكيد إلى عنوان بريدك الإلكتروني الجديد',
  ...
  en: {
    ...
    emailConfirmationSent: 'A confirmation email has been sent to your new email address',
